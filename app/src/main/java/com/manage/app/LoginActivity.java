...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /*loginGoogle.setOnClickListener(new View.OnClickListener() {
        ...
        register.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(LoginActivity.this,CheckManagerActivity.class));
            }
        });
    ...
    public void onStart() {
        ...
        if(new SessionManager(LoginActivity.this).checkLogin()){
            startActivity(new Intent(LoginActivity.this, CustomerActvity.class));
            finish();
        }
    }
    ...
    public void processLogin(){
        ...
        DatabaseReference DBref =  FirebaseDatabase.getInstance().getReference("managers");
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                ...
                if(snapshot.exists()){
                    ...
                    if(passwordFromDB.equals(password)){
                        ...
                        sessionManager.createLoginSession(version.toString(),firstNameFromDB,lastNameFromDB,emailFromDB,phoneFromDB,passwordFromDB);
