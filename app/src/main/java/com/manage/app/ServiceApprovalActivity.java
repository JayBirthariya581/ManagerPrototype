...
public class ServiceApprovalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(ServiceApprovalActivity.this,R.color.yelight));


        modelBookingList = new ArrayList<>();
        adapter = new BookingListAdapter(modelBookingList,ServiceApprovalActivity.this);
